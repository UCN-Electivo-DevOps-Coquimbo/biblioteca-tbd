...
def reserve_study_room_user(study_room_id, user_id):
    ...
    for study_room in study_rooms:
        if study_room['id'] == study_room_id:
            ...
            study_room['user_id'] = user_id
            break
                
    with open(JSON_FILE, 'w') as file:        
        json.dump(study_rooms, file, indent=2)

def reserve_study_room_flow(user_id):
    study_rooms = {}
    ...
    while True:
        ...
        if study_room_id not in study_rooms:
            ...
            break
    result = reserve_study_room_user(study_room_id, user_id)
